...
export default function DeleteConfirmDialog({ rule, onCancel, onConfirm }: DeleteConfirmDialogProps) {
  if (!rule) return null;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm rounded-xl bg-white p-6 shadow-xl">
        ...
        <h3 className="mt-3 text-base font-semibold text-slate-900">Delete this rule?</h3>
        <p className="mt-1 text-sm text-slate-500">
          <span className="font-medium text-slate-700">{rule.name}</span> will stop applying at
          checkout immediately. This can&apos;t be undone.
        </p>
